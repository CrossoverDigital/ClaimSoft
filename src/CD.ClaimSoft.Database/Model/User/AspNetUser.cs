...
namespace CD.ClaimSoft.Database.Model.User
{
    ...
    public class AspNetUser
    {
        ...
        /// <summary>
        /// Child AgencyUsers where [AgencyUser].[AspNetUserId] point to this  (FK_AgencyUser_AspNetUsers)
        /// </summary>
        public ICollection<AgencyUser> AgencyUsers { get; set; } // AgencyUser.FK_AgencyUser_AspNetUsers
        /// <summary>
        /// Child AspNetUserClaims where [AspNetUserClaims].[UserId] point to this  (FK_dbo.AspNetUserClaims_dbo.AspNetUsers_UserId)
        /// </summary>
        ...
        /// <summary>
        /// Child AspNetUserLogins where [AspNetUserLogins].[UserId] point to this  (FK_dbo.AspNetUserLogins_dbo.AspNetUsers_UserId)
        /// </summary>
        ...
        /// <summary>
        /// Child AspNetUserRoles where [AspNetUserRoles].[UserId] point to this  (FK_dbo.AspNetUserRoles_dbo.AspNetUsers_UserId)
        /// </summary>

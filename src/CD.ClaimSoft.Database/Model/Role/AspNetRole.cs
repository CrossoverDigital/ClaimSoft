...
using CD.ClaimSoft.Database.Model.User;

namespace CD.ClaimSoft.Database.Model.Role
{
    public class AspNetRole
    {
        ...
        /// <summary>
        /// Child AspNetUserRoles where [AspNetUserRoles].[RoleId] point to this  (FK_dbo.AspNetUserRoles_dbo.AspNetRoles_RoleId)
        /// </summary>

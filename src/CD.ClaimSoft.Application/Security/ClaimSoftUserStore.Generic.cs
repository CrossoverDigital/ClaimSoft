...
namespace CD.ClaimSoft.Application.Security
{
    ...
    /// <typeparam name="TTenantKey">The type of <see cref="IClaimSoftUser{TKey, TTenantKey}.TenantId"/> for a user.</typeparam>
    ...
    public class ClaimSoftUserStore<TUser, TRole, TKey, TTenantKey, TUserLogin, TUserRole, TUserClaim>
        ...
        where TUserClaim : IdentityUserClaim<TKey>, new()
    {
        ...
        /// <see cref="ClaimSoftUserStore{TUser, TRole, TKey, TTenantKey, TUserLogin, TUserRole, TUserClaim}"/> class.
        /// </summary>
        ...
        public override Task CreateAsync(TUser user)
        {
            ...
            var testUser = "ChangeMe";

            // Need to set the tenant Id.
            //user.TenantId = TenantId;
            user.CreateBy = testUser;
            user.CreateDate = now;
            user.LastModifyBy = testUser;
            user.LastModifyDate = now;
        ...
        {
            ThrowIfInvalid();
            return GetUserAggregateAsync(u => string.Equals(u.Email, email, StringComparison.CurrentCultureIgnoreCase));
            //&& u.TenantId.Equals(TenantId));
        }

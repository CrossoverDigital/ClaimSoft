...
/****** Object:  Table [dbo].[Country]    Script Date: 12/15/2017 2:51:12 PM ******/
...
ALTER TABLE [dbo].[Country] ADD  CONSTRAINT [DF_Country_CreateBy]  DEFAULT ('CDUNCAN') FOR [CreateBy]
GO

ALTER TABLE [dbo].[Country] ADD  CONSTRAINT [DF_Country_CreateDate]  DEFAULT (getdate()) FOR [CreateDate]
GO

ALTER TABLE [dbo].[Country] ADD  CONSTRAINT [DF_Country_LastModifyBy]  DEFAULT ('CDUNCAN') FOR [LastModifyBy]
GO

ALTER TABLE [dbo].[Country] ADD  CONSTRAINT [DF_Country_LastModifyDate]  DEFAULT (getdate()) FOR [LastModifyDate]
GO

USE [cdTest]
GO

INSERT INTO [dbo].[Country] ([Iso],[Name],[NiceName],[Iso3],[NumCode],[PhoneCode]) VALUES
